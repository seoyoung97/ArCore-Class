...
public class Cube {
    ...
    public void draw() {
        ...
        GLES30.glVertexAttribPointer(color, 4, GLES30.GL_FLOAT, false, 4 * 4, mColors);

        GLES30.glDrawElements(GLES30.GL_TRIANGLES, 36, GLES30.GL_UNSIGNED_SHORT, mIndices);
...
//        System.out.println("큐브 getPoint() 여: "+Arrays.toString(minPonit));
